...
const icons: Map<string, any> = new Map([
	...
	[EIcon.HAND, mdi.mdiHandBackLeftOutline],
	[EIcon.INFO, mdi.mdiInformationOutline],
	[EIcon.LOADING, mdi.mdiLoading],
	[EIcon.LOCK, mdi.mdiLock],
	[EIcon.ORGANIZATION, mdi.mdiLan],
	[EIcon.PEOPLE, mdi.mdiAccountGroup],
	[EIcon.POLL, mdi.mdiPoll],
	[EIcon.QUIZ, mdi.mdiTextBoxCheckOutline],
